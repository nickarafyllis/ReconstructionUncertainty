...
########### BDTG ############
#{'learning_rate': 0.1, 'max_depth': 3, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 100}
...
params = {'n_estimators':n_estimators, 'max_depth': 3,
          'learning_rate': 0.1, 'min_samples_leaf': 1, 'min_samples_split': 3
          } 
...
filename = 'models/finalized_BDTmodel_forMuonEnergy_trueTrackLengthInMrd.sav'
...
#plt.savefig("BDT_plots_trueMRD/deviation_train_test.png")
